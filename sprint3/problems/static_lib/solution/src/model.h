...
struct LootInfo
{
	LootInfo(unsigned type, double coordx, double coordy)
	: id{type}, x{coordx}, y{coordy}
	{}
	unsigned id;
	double x;
	double y;
...
/*    	        std::cout << "Loot:" << std::endl;
    	        ...
    	        std::cout << "file:" << loot_object.at("file").as_string().data() << std::endl;
    	        std::cout << "type:" << loot_object.at("type").as_string().data() << std::endl;
    	        if(loot_object.contains("rotation"))
    	        		std::cout << "rotation:" << loot_object.at("rotation").as_int64() << std::endl;
    	        if(loot_object.contains("color"))
    	        		std::cout << "color:" << loot_object.at("color").as_string().data() << std::endl;
    	        std::cout << "scale:" << loot_object.at("scale").as_double() << std::endl;
  */
    	   }
